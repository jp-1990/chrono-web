<template>
  ...
  <!--   CALL POST http://localhost:8000/api/v1/activity -->
  <!-- </button> -->
  ...
  <!-- </button> -->
  <!-- <button @click="getAllTest"> -->
  <!--   CALL GET http://localhost:8000/api/v1/activity -->
  <!-- </button> -->
  ...
  <!-- <button @click="signup"> -->
  <!--   CALL POST http://localhost:8000/api/v1/register -->
  <!-- </button> -->
  <!-- <google-sign-in-button -->
  <!--   @success="handleLoginSuccess" -->
  <!--   @error="handleLoginError" -->
  <!-- ></google-sign-in-button> -->
  <!-- <div class="h-1 w-full bg-slate-200 my-2" /> -->
</template>
...
//     'start',
//     new Date('2024-10-28T00:00:00.000').toISOString()
//   );
//   url.searchParams.set(
//     'end',
//     new Date('2024-11-13T23:59:59.999').toISOString()
//   );
//
//   /*
