<template>
  <div class="flex flex-col w-[calc(50%_-_0.5rem)]">
    <label :for="`${props.label}-input`" class="w-full text-xs mt-2 mb-1"
    ...
    <input
      ...
      class="w-full h-10 sm:h-9 bg-white border py-1 px-2 rounded-[3px] focus:outline-none focus:border-slate-500 text-sm/[24px] tracking-tighter text-slate-700 placeholder:text-slate-400/70"
