<template>
  ...
  >
    <NuxtLink
      ...
      :to="subroutes ? subroutes[0].url : url"
    ...
    >
      ...
      <menu-right
        v-if="subroutes"
        :class="[selected ? 'origin-center rotate-90' : '']"
    ...
    <ul
      v-if="subroutes"
      :style="[`height: ${selected ? 52 * subroutes.length : 0}px`]"
    ...
    >
      ...
      >
        <NuxtLink
          :to="subroute.url"
          class="flex w-full h-full items-center px-6"
        >
